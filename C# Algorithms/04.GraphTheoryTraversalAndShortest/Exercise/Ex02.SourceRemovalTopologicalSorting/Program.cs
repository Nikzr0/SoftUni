...
namespace Ex02.SourceRemovalTopologicalSorting
{
    internal class Program
    {
        ...
        private static Dictionary<string, int> GetCount()
        {
        ...
        private static Dictionary<string, List<string>> GraphReader(int n)
        {
